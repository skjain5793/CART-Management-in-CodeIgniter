...
<?php foreach ($this->cart->contents() as $items): ?>
        ...
        <tr>
				...
				<td><a href="remove_cart_item/<?php echo $items['rowid']; ?>">Remove</a></td>
        </tr>
...
<p><a href="<?php $this->cart->destroy(); ?>">Empty Cart</a><?php echo anchor('index.php','Continue Shopping'); ?><?php echo form_submit('', 'Update your Cart'); ?></p>